...
static const char col_gray2[] = "#292a44";
static const char col_gray3[] = "#f1eff8";
static const char col_gray4[] = "#3b3d63";
static const char col_cyan[] = "#8eaee0";
...
static const char *volume[3][5] = {
    {"/usr/bin/pactl", "set-sink-volume", "@DEFAULT_SINK@", "+10%", NULL},
    {"/usr/bin/pactl", "set-sink-volume", "@DEFAULT_SINK@", "-10%", NULL},
