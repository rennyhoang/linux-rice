...
static char *colors[][3] = {
       /*               fg           bg           border   */
       [SchemeNorm] = { termcol7, termcol0, termcol0 },
       [SchemeSel]  = { termcol15,  termcol0,  termcol15  },
};
...
/* tagging */
static const char *tags[] = { "一", "二", "三", "四", "五", "五", "七", "八", "九" };
...
static const char *dmenucmd[] = { "dmenu_run_history", "-m", dmenumon, "-fn", dmenufont, "-p", dmenuprompt, "-nb", termcol0, "-nf", termcol7, "-sb", termcol0, "-sf", termcol15, "-x", "12", "-y", "12", "-z", "1896", NULL };

static const char *termcmd[]  = { "st", NULL };

static const char scratchpadname[] = "scratchpad";
static const char *scratchpadcmd[] = { "st", "-t", scratchpadname, "-g", "60x25", NULL };
